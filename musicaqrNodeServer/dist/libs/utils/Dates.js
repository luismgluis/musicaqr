...
class Dates {
    ...
    dateToDaysHoursNowUnix(date1Unix, withSeconds = false) {
        const date1 = this.unixToDate(date1Unix);
        return this.dateToDaysHours(date1, new Date(), withSeconds);
    }
    dateToDaysHoursNow(date1, withSeconds = false) {
        return this.dateToDaysHours(date1, new Date(), withSeconds);
    }
    dateToDaysHours(date1, date2, withSeconds = false) {
    ...
    dateStringInputToString(str) {
        const d = this.dateStringInputToDateUnix(str);
        if (d)
            return this.unixToString(d);
        return "";
    }
    dateNow() {
        return new Date();
